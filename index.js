...
function multiplyArray(array) {
  let dobutok = 1;
  for (let item of array) {
    // console.log((dobutok = item * dobutok));
    // console.log((dobutok *= array));
    // dobutok *= item;
    dobutok = item * dobutok;
  }
  return dobutok;
